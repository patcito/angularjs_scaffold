 var <%= @controller%>IndexCtrl = ['$scope', '<%= @model_name%>', function($scope, <%= @model_name%>) {
...
var <%= @controller%>CreateCtrl = ['$scope', '$location', '<%= @model_name%>', function($scope, $location, <%= @model_name%>) {
  $scope.save = function() {
...
var <%= @controller%>ShowCtrl = ['$scope', '$location', '$routeParams', '<%= @model_name%>', function($scope, $location, $routeParams, <%= @model_name%>) {
...
var <%= @controller%>EditCtrl = ['$scope', '$location', '$routeParams', '<%= @model_name%>', function($scope, $location, $routeParams, <%= @model_name%>) {
  var self = this;
